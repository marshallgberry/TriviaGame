const questions = [{
  ...
  const dumbGame = document.querySelector('#dumbGame');
  const startCount = 30;
  
  var timer;
  var gameClock = startCount;
  ...
  function answeredIncorrect() {
	...
	function finalCountdown() {
		...
		gameClock = startCount;
		dumbGame.innerHTML = `
			<div class="timer">Seconds Left: <span class="gameClock">${startCount}</span></div>
		`;
		currentQuestion++;
		loadQuestion();
		}
